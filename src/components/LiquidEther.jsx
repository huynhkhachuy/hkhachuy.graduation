...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // ==== shaders (rút gọn comment, core giữ nguyên) ====
    const face_vert = `
...
`;
    ...
    class WebGLManager {
      constructor(props) {
        ...
        const Mouse = (this.Mouse = new MouseClass());
    ...
    // pause khi container không hiện trên viewport
    ...
    return () => {
      ...
      if (resizeObserverRef.current) { try { resizeObserverRefRef?.current?.disconnect?.(); } catch {} }
